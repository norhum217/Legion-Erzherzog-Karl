[README.md](https://github.com/user-attachments/files/31048477/README.md)
...
1. Pulsa **uploading an existing file** (o el botón **Add file → Upload
   files**).
2. Arrastra estos archivos tal cual te los doy (todos sueltos, sin carpetas):
   - `index.html`
   - `config.js`
   - `parsers.js`
   - `data-loader.js`
...
Todo va suelto en la misma carpeta — sin subcarpetas — para que subirlo a
GitHub arrastrando archivos no dé problemas de estructura.
